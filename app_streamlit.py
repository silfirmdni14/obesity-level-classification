...
.about-wrapper {{
    ...
    .about-card {{
        ...
        border-radius: 18px;
        padding: 28px 26px;
        box-shadow: 0 6px 24px rgba(28, 42, 85, 0.08);
    ...
    .profile-card img {{
        ...
        object-fit: cover;
        border-radius: 16px;
        box-shadow: 0 6px 18px rgba(28, 42, 85, 0.15);
        margin-bottom: 18px;
    }}
    .profile-name {{
        font-size: 22px;
...
with tab1:
    ...
    if predict_clicked:
        ...
        aktivitas = {
            ...
            "Normal_Weight":       ["🚶 Pertahankan aktivitas jalan kaki minimal 30 menit setiap hari","🥦 Konsumsi sayur dan buah rutin per hari","💧 Minum air putih minimal 2 liter per hari","🏊 Lakukan olahraga aerobik seperti renang atau bersepeda 3x seminggu","😴 Jaga kualitas tidur dan kelola stres dengan baik"],
...
with tab4:
    ...
    with col1:
        try:
            ...
            img_tag = f'<img src="data:image/jpeg;base64,{img_b64}" alt="Foto Profil"/>'
        except Exception:
            img_tag = ''
        ...
        <div class="about-card profile-card">
            {img_tag}
            <p class="profile-name">Silfi Dwi Ramadani</p>
            <div class="social-row">
                <a class="social-btn" href="mailto:silfiramadani86@gmail.com" target="_blank">✉️ Email</a>
                <a class="social-btn" href="https://www.instagram.com/silfirmdni_/" target="_blank">📸 Instagram</a>
                <a class="social-btn" href="https://github.com/silfirmdni14/" target="_blank">💻 GitHub</a>
            </div>
        </div>
        """, unsafe_allow_html=True)
    #KANAN : Tentang Saya
    with col2:
        ...
        <div class="about-card">
            ...
            <div class="about-text">
                Halo! Saya <b>Silfi Dwi Ramadani</b>, siswa kelas XI jurusan
                <b>Rekayasa Perangkat Lunak</b>. HealthPredict dikembangkan sebagai
                project persiapan <b>PKL</b> sekaligus penerapan kemampuan dalam
                membangun aplikasi <b>machine learning berbasis web</b>.
            </div>
        </div>
        """, unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
